...
- `rr-distribute/SKILL.md` — distribution skill. Takes a published post and produces LinkedIn (1200–1800 char), X thread (4–6 tweets), newsletter (600–900 words), and Pinterest pin description.
